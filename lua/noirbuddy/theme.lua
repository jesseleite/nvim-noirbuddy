...
Group.new('Normal', colors.gray_4, colors.black)
...
Group.new('LineNr', colors.gray_8, colors.black)
...
Group.new('CursorLineNr', colors.gray_6, colors.gray_8)
...
Group.new('@number', colors.gray_2)
...
Group.new('@function.macro', colors.gray_2)
...
Group.new('@operator', colors.gray_2)
