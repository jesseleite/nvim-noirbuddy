...
function M.setup(opts)
  ...
  Group.new('Search', nil, colors.white)
  Group.new('IncSearch', nil, colors.white)
  ...
  Group.new('DiffChange', colors.white, colors.noir_8)
  Group.new('DiffDelete', colors.secondary, colors.noir_8)
  Group.new('DiffText', colors.white, colors.noir_7)
  Group.new('ErrorMsg', colors.noir_1, colors.primary)
  Group.new('VertSplit', nil, colors.noir_9)
  ...
  Group.new('@constant.macro', colors.noir_2)
